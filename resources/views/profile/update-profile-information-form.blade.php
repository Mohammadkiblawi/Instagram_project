<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select class="mt-1 block w-full form-input rounded-md shadow-sm" id="status" name="status" wire:model.defer="state.status">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <select class="mt-1 block w-full form-input rounded-md shadow-sm" id="language" name="language" wire:model.defer="state.language">
